...
remnux-python3-packages-stringsifter-source:
  git.cloned:
...
remnux-python3-packages-stringsifter-requirements-lightgbm:
  file.replace:
    ...
    - require:
      - git: remnux-python3-packages-stringsifter-source

remnux-python3-packages-stringsifter-requirements-numpy:
  file.replace:
    - name: /usr/local/src/stringsifter/requirements.txt
...
remnux-python3-packages-stringsifter-requirements-joblib:
  file.replace:
    - name: /usr/local/src/stringsifter/requirements.txt
    - pattern: joblib==0.13.2
    - repl: joblib>=0.13.2,<0.17
    - count: 1
    - prepend_if_not_found: false
    - require:
      - git: remnux-python3-packages-stringsifter-source

remnux-python3-packages-stringsifter-requirements-scikit:
  file.replace:
    - name: /usr/local/src/stringsifter/requirements.txt
    - pattern: scikit-learn==0.21.3
    - repl: scikit-learn>=0.21.3,<0.24
remnux-python3-packages-stringsifter-requirements-pytest:
  file.replace:
    - name: /usr/local/src/stringsifter/requirements.txt
...
remnux-python3-packages-stringsifter-requirements-fasttext:
  file.replace:
    - name: /usr/local/src/stringsifter/requirements.txt
