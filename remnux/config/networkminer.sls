...
remnux-config-rename-networkminer-assembledfiles:
  file.rename:
    - name: /usr/local/NetworkMiner_2-8/AssembledFiles.original
    - source: /usr/local/NetworkMiner_2-8/AssembledFiles
    - force: true
    - makedirs: True
    - require:
...
remnux-config-networkminer-assembledfiles-link:
  file.symlink:
    - name: /usr/local/NetworkMiner_2-8/AssembledFiles
...
remnux-config-rename-networkminer-captures:
  file.rename:
    - name: /usr/local/NetworkMiner_2-8/Captures.original
    - source: /usr/local/NetworkMiner_2-8/Captures
    - force: true
    - makedirs: True
    - require:
      - sls: remnux.tools.networkminer
...
remnux-config-networkminer-captures-link:
  file.symlink:
    - name: /usr/local/NetworkMiner_2-8/Captures
