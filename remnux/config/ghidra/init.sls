...
remnux-config-ghidra-file-preferences:
  file.managed:
    - name: {{ home }}/.ghidra/.ghidra_9.2_PUBLIC/preferences 
...
remnux-config-ghidra-file-tool-code-browser:
  file.managed:
    - name: {{ home }}/.ghidra/.ghidra_9.2_PUBLIC/tools/_code_browser.tcd
...
remnux-config-ghidra-file-tool-version-tracking:
  file.managed:
    - name: {{ home }}/.ghidra/.ghidra_9.2_PUBLIC/tools/_version _tracking.tcd
